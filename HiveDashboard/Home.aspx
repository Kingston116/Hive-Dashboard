<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="HiveDashboard.Home" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center"><asp:Label ID="lblQA" runat="server" Text="0"></asp:Label></div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center"><asp:Label ID="lblP1" runat="server" Text="0"></asp:Label></div>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div id="site-statistics" style="height:250px;">
                                        <asp:Panel runat="server" ScrollBars="Both" Height="248px">
                                        <asp:GridView ID="grdBug" runat="server" CssClass="table">
                    ...
                    <div class="panel panel-grape">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div id="budget-variance" style="height:250px;">

                                        <asp:Panel runat="server" ScrollBars="Both">
                                        <asp:GridView ID="grdBugMonth" runat="server" CssClass="table">
                                        </asp:GridView></asp:Panel>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xs-12 col-md-3 col-sm-6 col-lg-3">
                    <a class="info-tiles tiles-orange" href="#">
                        ...
                        <div class="tiles-body">
                            ...
                            <div class="pull-right"><asp:Label ID="lblWebOpenBugs" runat="server" Text="0"></asp:Label><div id="indexinfolikes" style="margin-top: 10px; margin-bottom: -10px;"></div></div>
                        </div>
                    </a>
                </div>
                <div class="col-xs-12 col-md-3 col-sm-6 col-lg-3">
                    ...
                    <div class="panel panel-grape">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                   <asp:GridView ID="grdNGD" runat="server" CssClass="table"></asp:GridView>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-orange">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <asp:GridView ID="grdAnd" runat="server" CssClass="table"></asp:GridView>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 clearfix">
                                    ...
                                    <div class="btn-group pull-right">
                                        <asp:GridView ID="grdWeb" runat="server" CssClass="table"></asp:GridView>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-orange">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <asp:GridView ID="grdIOS" runat="server" CssClass="table"></asp:GridView></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                               <asp:Panel runat="server" ScrollBars="Horizontal">
                                   <asp:GridView ID="grdResource" runat="server" CssClass="table"></asp:GridView>
                               </asp:Panel>
